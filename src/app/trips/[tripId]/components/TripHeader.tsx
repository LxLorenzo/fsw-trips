  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="flex flex-col p-5 lg:order-1 lg:p-0 lg:mb-10">
        <h1 className="text-primaryDarker dark:text-walterWhite font-semibold text-xl lg:text-3xl">
          {trip.name}
        </h1>

        <div className="flex items-center gap-1 my-1">
          <ReactCountryFlag countryCode={trip.countryCode} svg />
          <p className="text-xs text-grayPrimary dark:text-graySecondary underline lg:text-base">
            {trip.location}
          </p>
        </div>

        <p className="text-xs text-grayPrimary dark:text-graySecondary lg:hidden">
